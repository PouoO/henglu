...
class ThemePalettes {
  ...
  static const String creamBerryId = 'cream_berry';

  // 奶霜莓粉 — 衡庐默认配色
  static const ThemePalette creamBerry = ThemePalette(
    id: creamBerryId,
    zhName: '奶霜莓粉',
    enName: 'Cream Berry',
    light: ColorScheme(
      brightness: Brightness.light,
      primary: Color(0xFFD98B9A),
      onPrimary: Color(0xFFFFFFFF),
      primaryContainer: Color(0xFFF5D5DC),
      onPrimaryContainer: Color(0xFF5C2238),
      secondary: Color(0xFF8BB4C9),
      onSecondary: Color(0xFFFFFFFF),
      secondaryContainer: Color(0xFFD6E8F0),
      onSecondaryContainer: Color(0xFF1A3540),
      tertiary: Color(0xFFC9A0B4),
      onTertiary: Color(0xFFFFFFFF),
      tertiaryContainer: Color(0xFFF0E0E8),
      onTertiaryContainer: Color(0xFF3A1A2A),
      error: Color(0xFFBB0947),
      onError: Color(0xFFFFFFFF),
      errorContainer: Color(0xFFFDDADE),
      onErrorContainer: Color(0xFF400013),
      surface: Color(0xFFF9F5F2),
      onSurface: Color(0xFF2D2424),
      onSurfaceVariant: Color(0xFF5C504C),
      outline: Color(0xFFB0A0A0),
      outlineVariant: Color(0xFFD8D0CC),
      shadow: Color(0xFF000000),
      scrim: Color(0xFF000000),
      inverseSurface: Color(0xFF2D2424),
      onInverseSurface: Color(0xFFF9F5F2),
      inversePrimary: Color(0xFFD98B9A),
      surfaceTint: Color(0xFFD98B9A),
    ),
    dark: ColorScheme(
      brightness: Brightness.dark,
      primary: Color(0xFFE8A5B4),
      onPrimary: Color(0xFF3A1520),
      primaryContainer: Color(0xFF8A5560),
      onPrimaryContainer: Color(0xFFF5D5DC),
      secondary: Color(0xFF9BC5D9),
      onSecondary: Color(0xFF1A3540),
      secondaryContainer: Color(0xFF3A5560),
      onSecondaryContainer: Color(0xFFD6E8F0),
      tertiary: Color(0xFFD4B0C0),
      onTertiary: Color(0xFF3A1A2A),
      tertiaryContainer: Color(0xFF5A3848),
      onTertiaryContainer: Color(0xFFF0E0E8),
      error: Color(0xFFFCB4BD),
      onError: Color(0xFF670023),
      errorContainer: Color(0xFF910034),
      onErrorContainer: Color(0xFFFCB4BD),
      ...
      onSurfaceVariant: Color(0xFFC0B8B4),
      outline: Color(0xFF8A807C),
      outlineVariant: Color(0xFF454040),
      shadow: Color(0xFF000000),
      scrim: Color(0xFF000000),
      inverseSurface: Color(0xFFF0EAE6),
      onInverseSurface: Color(0xFF1F1A1A),
      inversePrimary: Color(0xFFD98B9A),
      surfaceTint: Color(0xFFE8A5B4),
    ),
  );
